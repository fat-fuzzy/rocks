...
function generateRoutingConfig(config /** @FatFuzzyConfig */) {
	...
	fs.writeFileSync(
		...
		/* eslint-disable */
		/**
		 * This file was automatically generated by @fat-fuzzy/validation
		 * DO NOT MODIFY IT BY HAND. Instead:
		 * - modify the source configuration file: fat-fuzzy.config.js
		 * - run ff-validation to regenerate this file.
		 */
