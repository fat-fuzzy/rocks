<div class="l:grid:tram">
	<div class="l:grid t-zone:1 surface:1:primary variant:outline">
	...
	<details class="l:grid t-zone:2 gare:ouest surface:2:highlight">
	...
	<div
		class="l:grid t-zone:3 snap:start surface:2:primary variant:outline t-zone:playground align-self:stretch align-content:stretch"
	>
		<div class="l:grid t-zone:main scroll:y surface:1:primary">
	...
	<div class="l:grid t-zone:4 surface:2:primary">
