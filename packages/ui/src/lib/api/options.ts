...
export const STYLE_CAPSULES: {
	[theme: string]: {tag: string}
} = {
	ui: {
		tag: 'style-capsule-ui',
		// load: async () => await import('../styles/app/ui/_main.scss?inline'),
	},
	doc: {
		tag: 'style-capsule-doc',
		// load: async () => await import('../styles/app/doc/_main.scss?inline'),
	},
	website: {
		tag: 'style-capsule-website',
		// load: async () => await import('../styles/app/client/_main.scss?inline'),
	},
}
