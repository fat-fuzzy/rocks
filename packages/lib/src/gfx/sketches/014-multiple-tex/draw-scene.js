...
function drawScene(gl, programInfo, buffers) {
	...
	for (let i = 0; i < programInfo.context.images.length; i++) {
	...
	gl.uniform1i(programInfo.uniformLocations.u_image0, 0)
	gl.uniform1i(programInfo.uniformLocations.u_image1, 1)
